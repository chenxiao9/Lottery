...
import com.chen.mvpmaterial.injector.components.DaggerNewsArticleComponent;
...
import com.chen.mvpmaterial.utils.AnimateHelper;
import com.chen.mvpmaterial.utils.DialogHelper;
...
import com.chen.mvpmaterial.widget.PullScrollView;
...
public class NewsArticleActivity extends BaseSwipeBackActivity<IBaseContract.presenter> implements INewsArticleView {
    ...
    public void loadData(NewsDetailInfo newsDetailBean) {
        ...
        RichText.from(newsDetailBean.getBody()).into(mTvContent);
